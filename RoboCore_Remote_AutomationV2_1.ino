    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n') {
          ...
          client.println("<link rel='stylesheet' type='text/css' href='https://umsonhodemilgatos.ong.br/minhacasa/RemoteAutomationV2.0.css' />");
          client.println("<script type='text/javascript' src='https://umsonhodemilgatos.ong.br/minhacasa/RemoteAutomationV2.0.js'/></script>");
